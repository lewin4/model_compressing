...
def _is_optimizable(layer: nn.Module, subvector_size: int) -> bool:
    ...
    if isinstance(layer, nn.Conv2d) or isinstance(layer, nn.ConvTranspose2d):
        _, _, height, width = layer.weight.shape        #获取卷积核的尺寸，3*3，或者7*7，或者1*1卷积
...
def permute_model(
    ...
    permutation_groups: YAMLParserResult = None,            #list class
    ...
    Parameters:
        ...
        pw_subvector_size: Subvect size for pointwise convolutions      1*1卷积
    ...
    for group in permutation_groups:
        ...
        # print(parent_names)------>['layer1.0.conv1', 'layer1.0.bn1']
        # print(parent_dict)------->OrderedDict([('layer1.0.conv1', Conv2d(64, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)), ('layer1.0.bn1', BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True))])
        # spec 规格，标准
